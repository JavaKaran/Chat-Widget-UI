        ...
        <div className="border-t-2 border-gray-200 p-2 sm:p-6 sm:mb-0 shadow-lg">
            <div className="relative flex justify-around">
                <textarea 
                    ...
                    className="w-[90%] border-none focus:placeholder-gray-400 placeholder-gray-600 text-black outline-none bg-[#f1f1f1] rounded-md px-2 py-[10px] sm:p-4 resize-none text-[12px] leading-[17px] sm:text-sm message-input " 
                    ref={textAreaRef} 
