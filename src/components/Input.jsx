        ...
        <div className="border-t-2 border-gray-200 p-3 sm:p-6 sm:mb-0">
            <div className="relative flex justify-around">
                ...
                <div className="items-center flex">
                    <button type="button" className="flex items-center justify-center rounded-lg p-3 ml-2 sm:ml-0 sm:px-4 sm:py-3 transition duration-500 ease-in-out text-white bg-[#2C2D98] hover:bg-[#5658d8] focus:outline-none" onClick={handleSendClick} disabled={isTyping}>
