...
const MessageMenu = ({ showMessageMenu, handleMessageMenu, primaryColor, setShowReport }) => {
    ...
    return (
        <div className={`absolute top-0 w-full h-full z-20 ${showMessageMenu ? 'block' : 'hidden'}`} onClick={handleMessageMenu}>
            <div className=" bg-[rgba(0,0,0,0.7)] flex justify-end flex-col h-full w-full">
                <div className={`rounded-t-xl bg-white p-3 pb-2 transition ease-in-out duration-500 ${showMessageMenu ? 'block' : 'hidden'}`}>
                    <div className="flex items-center justify-start p-2">
                        <div className="flex">
                            <svg width="14" height="18" viewBox="0 0 18 20" fill={primaryColor} xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 14.08C14.24 14.08 13.56 14.38 13.04 14.85L5.91 10.7C5.96 10.47 6 10.24 6 10C6 9.76 5.96 9.53 5.91 9.3L12.96 5.19C13.5 5.69 14.21 6 15 6C16.66 6 18 4.66 18 3C18 1.34 16.66 0 15 0C13.34 0 12 1.34 12 3C12 3.24 12.04 3.47 12.09 3.7L5.04 7.81C4.5 7.31 3.79 7 3 7C1.34 7 0 8.34 0 10C0 11.66 1.34 13 3 13C3.79 13 4.5 12.69 5.04 12.19L12.16 16.35C12.11 16.56 12.08 16.78 12.08 17C12.08 18.61 13.39 19.92 15 19.92C16.61 19.92 17.92 18.61 17.92 17C17.92 15.39 16.61 14.08 15 14.08Z" />
                            </svg>
                        </div>
                        <p className="mb-0 ml-3 text-[12px] leading-[12px]" style={{ color: primaryColor }}>Share</p>
                    </div>
                    <div className="flex items-center justify-start p-2 border-y border-[#ececec]">
                        <div className="flex">
                            <svg width="16" height="17" viewBox="0 0 20 21" fill={primaryColor} xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="mb-0 ml-3 text-[12px] leading-[12px]" style={{ color: primaryColor }}>View Sources</p>
                    </div>
                    <div className="flex items-center justify-start p-2" onClick={handleReport}>
                        <div className="flex">
                            <svg width="14" height="16" viewBox="0 0 15 17" fill={primaryColor} xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 17V0H9L9.4 2H15V12H8L7.6 10H2V17H0ZM9.65 10H13V4H7.75L7.35 2H2V8H9.25L9.65 10Z" />
                            </svg>
                        </div>
                        <p className="mb-0 ml-3 text-[12px] leading-[12px]" style={{ color: primaryColor }}>Report Message</p>
                    </div>
                </div>
            </div>
        </div>
