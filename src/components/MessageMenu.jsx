        ...
        <div className={`absolute top-0 w-full h-full z-20 ${showMessageMenu ? 'block' : 'hidden'}`} onClick={handleMessageMenu}>
            <div className=" bg-[rgba(0,0,0,0.7)] flex justify-end flex-col h-full w-full">
                <div className={`message-menu-ct rounded-t-xl bg-white p-3 pb-2 transition ease-in-out duration-500 divide-y divide-[#000000] ${showMessageMenu ? 'block' : 'hidden'}`}>
                    <div className="menu-item flex items-center justify-start p-[8px] " onClick={()=>{}}>
                        <div className="flex">
                    ...
                    <div className="menu-item flex items-center justify-start p-[8px]" onClick={handleSources}>
                        <div className="flex">
                    ...
                    <div className="menu-item flex items-center justify-start p-[8px]" onClick={handleReport}>
                        <div className="flex">
