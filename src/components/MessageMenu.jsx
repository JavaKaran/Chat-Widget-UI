    ...
    return (
        <div className={`absolute top-0 w-full h-full z-20 ${showMessageMenu ? 'block' : 'hidden'}`} onClick={handleMessageMenu}>
            <div className=" bg-[rgba(0,0,0,0.7)] flex justify-end flex-col h-full w-full">
                <div className={`rounded-t-xl bg-white p-3 pb-2 transition ease-in-out duration-500 divide-y divide-[#000000] ${showMessageMenu ? 'block' : 'hidden'}`}>
                    <div className="flex items-center justify-start p-3" onClick={()=>{}}>
                        <div className="flex">
                        ...
                        <p className="mb-0 ml-4 text-[16px] leading-[16px] text-semibold" style={{ color: primaryColor }}>Share</p>
                    </div>
                    <div className="flex items-center justify-start p-3" onClick={handleSources}>
                        <div className="flex">
                        ...
                        <p className="mb-0 ml-4 text-[16px] leading-[16px]" style={{ color: primaryColor }}>View Sources</p>
                    </div>
                    <div className="flex items-center justify-start p-3" onClick={handleReport}>
                        <div className="flex">
                        ...
                        <p className="mb-0 ml-4 text-[16px] leading-[16px]" style={{ color: primaryColor }}>Report Message</p>
                    </div>
                </div>
            </div>
        </div>
